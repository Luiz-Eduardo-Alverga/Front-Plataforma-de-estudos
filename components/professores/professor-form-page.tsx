...
export function TeacherForm({ mode, id }: TeacherFormProps) {
  ...
  const { mutateAsync: createProfessorFn, isPending: isCreatingTeacher } = useCreateTeacher()
  const { mutateAsync: updateProfessorFn, isPending: isUpdatingTeacher } = useEditTeacher()
